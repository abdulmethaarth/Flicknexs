...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if(state.equalsIgnoreCase("off")){
            ...
            if (remoteMessage.getData() != null) {
                ...
                String imageUrl = String.valueOf(remoteMessage.getNotification().getIcon());
    ...
    private void sendNotification(String title, String messageBody, String imageUrl, String name,String smallIcon) {
       ...
       // TaskStackBuilder stackBuilder = TaskStackBuilder.create(this);
        ...
        notification
                .setSmallIcon(R.drawable.ic_stat_chhimbal_logo_2) // can use any other icon
                .setColor(ContextCompat.getColor(this, R.color.appcolor))
