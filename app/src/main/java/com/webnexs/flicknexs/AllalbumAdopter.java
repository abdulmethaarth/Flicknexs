...
class AllalbumAdopter extends RecyclerView.Adapter<AllalbumAdopter.MyViewHolder> {



    private List<allalbum> audiocatlist;
    private Context context;

    private static int currentPosition = 0;

    public AllalbumAdopter(List<allalbum> audiocatllist, Context context) {
    ...
    public AllalbumAdopter(List<allalbum> audiocatlist) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        allalbum aud = audiocatlist.get(position);
