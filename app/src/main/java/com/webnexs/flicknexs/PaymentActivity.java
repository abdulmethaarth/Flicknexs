...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent in=getIntent();
        String timing= in.getStringExtra("period");
        String payment=  in.getStringExtra("amonut");


        amount.setText("You are paying Rs."+payment+" for this transaction.");
        period.setText("for "+timing+"");
