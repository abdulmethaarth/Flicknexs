...
class sidemennu2Adopter extends RecyclerView.Adapter<sidemennu2Adopter.MyViewHolder> {
    ...
    private List<sidemenu2> sidemenulist2;
    private Context context;

    private static int currentPosition = 0;

    public sidemennu2Adopter(List<sidemenu2> sidemenulist2, Context context) {
    ...
    public sidemennu2Adopter(List<sidemenu2> sidemenulist2) {
        this.sidemenulist2 = sidemenulist2;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        sidemenu2 sidemenu2 = sidemenulist2.get(position);
        holder.name1.setText(sidemenu2.getName1());
