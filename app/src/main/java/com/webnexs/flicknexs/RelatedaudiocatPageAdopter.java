...
class RelatedaudiocatPageAdopter extends RecyclerView.Adapter<RelatedaudiocatPageAdopter.MyViewHolder> {
    ...
    public RelatedaudiocatPageAdopter(List<Audiocatpage> audiocatllist, Context context) {
    ...
    public RelatedaudiocatPageAdopter(List<Audiocatpage> audiocatlist) {
