...
class upnextAdopter extends RecyclerView.Adapter<upnextAdopter.MyViewHolder> {
    ...
    public upnextAdopter(List<Audiocatpage> audiocatllist, Context context) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView name, url,id,duration;
    ...
    public upnextAdopter(List<Audiocatpage> audiocatlist) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.upnext, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.duration.setText(aud.getDuration());
