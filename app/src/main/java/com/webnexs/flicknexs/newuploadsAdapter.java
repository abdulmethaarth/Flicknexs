...
class newuploadsAdapter extends RecyclerView.Adapter<newuploadsAdapter.MyViewHolder> {
    ...
    public newuploadsAdapter(List<newuploads> uploadlist, Context context) {
    ...
    public newuploadsAdapter(List<newuploads> newuploadsList) {
