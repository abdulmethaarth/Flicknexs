...
class AudiopagecatAdopter extends RecyclerView.Adapter<AudiopagecatAdopter.MyViewHolder> {
    ...
    public AudiopagecatAdopter(List<Audiocat> audiocatllist, Context context) {
    ...
    public AudiopagecatAdopter(List<Audiocat> audiocatlist) {
