...
class vidcatAdopter extends RecyclerView.Adapter<vidcatAdopter.MyViewHolder> {



    private List<vidcat> vidcatlist;
    private Context context;

    private static int currentPosition = 0;

    public vidcatAdopter(List<vidcat> vidcatlist, Context context) {
    ...
    public vidcatAdopter(List<vidcat> vidcatlist) {
        this.vidcatlist = vidcatlist;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.vid_cat, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        vidcat vid = vidcatlist.get(position);
