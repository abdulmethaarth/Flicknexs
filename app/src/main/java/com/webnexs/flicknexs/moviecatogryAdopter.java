...
class moviecatogryAdopter extends RecyclerView.Adapter<moviecatogryAdopter.MyViewHolder> {
    ...
    public moviecatogryAdopter(List<moviecatogry> movielist, Context context) {
    ...
    public moviecatogryAdopter(List<moviecatogry> movielist) {
        this.movielist = movielist;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.movie_category_tab, parent, false);
