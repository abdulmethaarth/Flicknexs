...
import static com.webnexs.flicknexs.Connectivity.isConnectedFast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vidback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    player.stop();
                    Intent in=new Intent(MoviesActivity.this,UserHomeActivity.class);
                    startActivity(in);
                }
            }
        });
        ...
        RequestQueue queue2 = Volley.newRequestQueue(MoviesActivity.this);
        queue2.add(request);
            ...
            public void onClick(View view) {

                {
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, wishlistvid, new Response.Listener<String>() {
                        ...
                        @Override
                        public void onErrorResponse(VolleyError volleyError) {
                            Toast.makeText(MoviesActivity.this, "You are not a registered user", Toast.LENGTH_LONG).show();
        ...
        StringRequest request4 = new StringRequest(Request.Method.POST, videodetailsurl, new Response.Listener<String>() {
            ...
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                Toast.makeText(MoviesActivity.this, "Check Your Internet Connection", Toast.LENGTH_LONG).show();
        ...
        RequestQueue queue4 = Volley.newRequestQueue(MoviesActivity.this);
        queue4.add(request4);
...
*/
        ...
        RequestQueue thismaylikequeue = Volley.newRequestQueue(MoviesActivity.this);
        ...
        thismaylikerecycler.addOnItemTouchListener(
                new RecyclerItemClickListener(MoviesActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
                                ...
                                public void onResponse(String response) {
                                    try {
                                        ...
                                        if (jsonObject.getString("ppv_status").equalsIgnoreCase("expired") ) {
                                            Intent in=new Intent(MoviesActivity.this,payperviewenableActivity.class);
                                        ...
                                        else if(jsonObject.getString("ppv_status").equalsIgnoreCase("pay_now"))
                                        {
                                            ...
                                            {
                                                Intent in=new Intent(MoviesActivity.this,MoviesActivity.class);
                                                in.putExtra("id",thismaylikeslist.get(position).getId());
                                                startActivity(in);
                                            }
    ...
    private void openBottomSheet() {
        ...
        RequestQueue watchqueue = Volley.newRequestQueue(MoviesActivity.this);
        ...
        mBottomSheetDialog = new Dialog(MoviesActivity.this, R.style.MaterialDialogSheet);
